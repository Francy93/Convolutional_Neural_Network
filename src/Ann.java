...
public class Ann{
	...
	private static final	int		BATCH_SIZE		= 4;//4	 , 2			//	number of samples processed before updating the weights
	private static final	int		EPOCHS			= 50;//50 , 30			//	number of dataset cycles
